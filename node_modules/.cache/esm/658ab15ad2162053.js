let Product,ProductImages,multer,path,CustomErrorHandler,fs,productSchema,productImagesSchema;_d21‍.x([["default",()=>_d21‍.o]]);_d21‍.w("../models",[["Product",["Product"],function(v){Product=v}],["ProductImages",["ProductImages"],function(v){ProductImages=v}]]);_d21‍.w("multer",[["default",["multer"],function(v){multer=v}]]);_d21‍.w("path",[["default",["path"],function(v){path=v}]]);_d21‍.w("../services",[["CustomErrorHandler",["CustomErrorHandler"],function(v){CustomErrorHandler=v}]]);_d21‍.w("fs",[["default",["fs"],function(v){fs=v}]]);_d21‍.w("../validators/productValidator",[["default",["productSchema"],function(v){productSchema=v}]]);_d21‍.w("../validators/productImagesValidator",[["default",["productImagesSchema"],function(v){productImagesSchema=v}]]);
...
const productController = {
    ...
    async getProductImagesByProductId(req, res, next) {
        ...
        try {
            ...
            _d21‍.g.console.log("products list:", productImages)
        } catch (err) {
            return next(CustomErrorHandler.serverError());
        }
        return res.json({
