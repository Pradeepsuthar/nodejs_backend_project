let express,registerController,loginController,userController,refreshController,isAuthenticated,isAdmin,productController;_8af‍.x([["default",()=>_8af‍.o]]);_8af‍.w("express",[["default",["express"],function(v){express=v}]]);_8af‍.w("../controller",[["registerController",["registerController"],function(v){registerController=v}],["loginController",["loginController"],function(v){loginController=v}],["userController",["userController"],function(v){userController=v}],["refreshController",["refreshController"],function(v){refreshController=v}]]);_8af‍.w("../middlewares/auth",[["default",["isAuthenticated"],function(v){isAuthenticated=v}]]);_8af‍.w("../middlewares/admin",[["default",["isAdmin"],function(v){isAdmin=v}]]);_8af‍.w("../controller/productController",[["default",["productController"],function(v){productController=v}]]);
